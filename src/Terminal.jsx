...
function runCommand(input, setLines, t, setLang) {
  ...
  switch (cmd) {
    ...
    case "stack":
      push([
        { kind: "out", t: "languages.....: go, python, sql, javascript" },
        { kind: "out", t: "data..........: postgresql, mysql, clickhouse, redis, elasticsearch" },
        { kind: "out", t: "messaging.....: kafka, rabbitmq, grpc, rest" },
        { kind: "out", t: "platform......: docker, kubernetes, gitlab ci/cd" },
        { kind: "out", t: "observability.: prometheus, grafana, zap" },
      ]);
      break;
    case "contact":
      push([
